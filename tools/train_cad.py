...
# Written by Huang
# This code refers to Densefusion writen by Chen
# --------------------------------------------------------
import argparse
import os
import random
...
parser.add_argument('--dataset_root', type=str, default = '/home/dell/yifeis/pose_estimation/scan2cad/dataset/', help='dataset root dir (''YCB_Video_Dataset'' or ''Linemod_preprocessed'')')
...
parser.add_argument('--resume_posenet', type=str, default = '',  help='resume PoseNet model') #pose_model_current.pth
